...
- [x] Scaffold the Project
  ...
  - Done: Created monorepo structure (apps/frontend via Angular CLI with SSR; apps/backend Spring Boot skeleton; infra/docker-compose; Dockerfiles; contracts/openapi.yaml; docs; .vscode settings; CI workflow; root README and env examples).
...
- [ ] Ensure Documentation is Complete
  ...
  Clean up the copilot-instructions.md file in the .github directory by removing all HTML comments.
   -->
  - To do at the end. Docs scaffolded (README, roadmap, architecture, contributing, security).
